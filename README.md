...
The manual_depth_Paper3.py file contains the computer vision algorithm for the extraction of the handle coordinates based on the markers. Also the interface with the kinematic_model.py is given.
